...
- (void) rollDices {
    ...
    for (int i=0; i<5; i++) {
        if (_heldDiceIndices[i] == @0) {  // unhold
            [_dices[i] roll];
        }
    }
...
//    NSLog(@"%@ %@ %@ %@ %@", _dices[0], _dices[1], _dices[2], _dices[3], _dices[4]);
    ...
    NSString* d1stateLeft  = _heldDiceIndices[0] == @1 ? @"[" : @"";
    NSString* d1stateRight = _heldDiceIndices[0] == @1 ? @"]" : @"";
    NSString* d2stateLeft  = _heldDiceIndices[1] == @1 ? @"[" : @"";
    NSString* d2stateRight = _heldDiceIndices[1] == @1 ? @"]" : @"";
    NSString* d3stateLeft  = _heldDiceIndices[2] == @1 ? @"[" : @"";
    NSString* d3stateRight = _heldDiceIndices[2] == @1 ? @"]" : @"";
    NSString* d4stateLeft  = _heldDiceIndices[3] == @1 ? @"[" : @"";
    NSString* d4stateRight = _heldDiceIndices[3] == @1 ? @"]" : @"";
    NSString* d5stateLeft  = _heldDiceIndices[4] == @1 ? @"[" : @"";
    NSString* d5stateRight = _heldDiceIndices[4] == @1 ? @"]" : @"";
